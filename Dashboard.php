            ...
            <div class="row clearfix">
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box-2 bg-light-blue hover-zoom-effect">
                        ...
                        <div class="content">
                            <div class="text"><?php echo date("d-F-Y");?></div>
                            <div class="number"><?php echo date("h:i A");?></div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box-2 bg-pink hover-zoom-effect">
                        ...
                        <div class="content">
                            ...
                            <div class="number"><?php echo $teacher; ?></div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box-2 bg-blue hover-zoom-effect">
                        ...
                        <div class="content">
                            ...
                            <div class="number"><?php echo $student; ?></div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box-2 bg-cyan hover-zoom-effect">
                        ...
                        <div class="content">
                            ...
                            <div class="number"><?php echo $dept; ?></div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            ...
            <div class="row clearfix">
                ...
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                    <div class="card">
                        ...
                        <div class="body">
<!--                           Pie Chart-->
                            <canvas id="pie-chart" width="1000" height="500"></canvas>
                        </div>
                    </div>
                </div>
                <!-- #END# Browser Usage -->
