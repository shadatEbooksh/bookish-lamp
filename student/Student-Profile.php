<?php
	...
	if(isset($_SESSION['studentEmail']) && isset($_SESSION['studentOTP'])){
...
<html lang="en">
    ...
    <link rel="icon" href="../1.ico" type="image/x-icon">
        ...
        <!-- Icon css link -->
        <link href="theme/vendors/material-icon/css/materialdesignicons.min.css" rel="stylesheet">
        ...
        <!-- Extra plugin css -->
        <link href="theme/vendors/owl-carousel/assets/owl.carousel.css" rel="stylesheet">
        <link href="theme/vendors/animate-css/animate.css" rel="stylesheet">
        
        <link href="theme/css/style.css" rel="stylesheet">
        <link href="theme/css/responsive.css" rel="stylesheet">
        
        <link rel="stylesheet" href="theme/css/colors/default.css" title="default">
        ...
        <link rel="alternate stylesheet" href="theme/css/colors/violet.css" title="violet">
        <link rel="alternate stylesheet" href="theme/css/colors/blue.css" title="blue">
        <link rel="alternate stylesheet" href="theme/css/colors/past.css" title="past">
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
        ...
        <!-- Extra plugin js -->
        <script src="theme/vendors/counter-up/waypoints.min.js"></script>
        <script src="theme/vendors/counter-up/jquery.counterup.min.js"></script>
        <script src="theme/vendors/isotope/imagesloaded.pkgd.min.js"></script>
        <script src="theme/vendors/isotope/isotope.pkgd.min.js"></script>
        <script src="theme/vendors/owl-carousel/owl.carousel.min.js"></script>
        
        <script src="theme/vendors/style-switcher/styleswitcher.js"></script>
        <script src="theme/vendors/style-switcher/switcher-active.js"></script>
        
        <script src="theme/vendors/animate-css/wow.min.js"></script>
